...
#include "../../CampusNagivationSystem/recordwidget.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_RecordWidget_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 41, 21)
    ...
    "RecordWidget\0on_pushButtonClean_clicked\0"
...
const QMetaObject RecordWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_RecordWidget.data,
      qt_meta_data_RecordWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_RecordWidget.stringdata))
